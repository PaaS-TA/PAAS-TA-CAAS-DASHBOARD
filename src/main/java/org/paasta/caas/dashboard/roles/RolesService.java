...
//    }
    ...
    public List<Roles> getRolesList(String roleSetCode) {
        return restTemplateService.send(Constants.TARGET_COMMON_API,REQ_URL + "/" + roleSetCode, HttpMethod.GET, null, List.class);
    }
}
