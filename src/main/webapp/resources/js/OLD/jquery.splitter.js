	...
	function SplitterManager() {
		...
		$(document.documentElement).mousedown(function(ev) {
			...
			if (dragObj) {
				...
				dragObj.resizebar.css("background-color", '#e5e5e5');
				var $body = $('body');
	...
	function Splitter(parent, div1, div2, horizontal, barwidth) {
		...
		if (horizontal) {
			...
			resizebar.css({
				...
				"height" : "100%",
				"cursor" : "col-resize",
				"background-image" : "url('../resources/images/icons/var_v.gif')",
			...
			resizebar.css({
				...
				"height" : barwidth,
				"cursor" : "row-resize",
				"background-image" : "url('../resources/images/icons/var_h.gif')",
				"background-position" : "center",
				"background-repeat": "no-repeat"
			});
