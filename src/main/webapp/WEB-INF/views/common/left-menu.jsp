...
<div>
    <ul>
        <li><a href="javascript:void(0);" onclick="procMovePage('/caas/cluster/overview');">[ HOME ]</a></li>
        <li><a href="javascript:void(0);" onclick="procMovePage('/caas/users');">[ USERS ]</a></li>
