...
<header class="header">
    <div class="logo">
        <a href="javascript:void(0);" onclick="procMovePage('/caas/clusters/overview');"><h1><img src="<c:url value="/resources/images/main/logo.png"/>" alt=""/></h1></a>
        ...
        <li><!-- <a href="#" class="fas fa-user"></a> -->
            <div class="btn-group">
                ...
                <div id="r_user" class="dropdown-menu">
                    <ul class="caas-user">
                        <li id="header-menu-accessInfo"><a href="javascript:void(0);" onclick="procMovePage('/caas/accessInfo');">Access</a></li>
                        <li id="header-menu-users"><a href="javascript:void(0);" onclick="procMovePage('/caas/users');">User</a></li>
                        <li id="header-menu-roles"><a href="javascript:void(0);" onclick="procMovePage('/caas/roles');">Role</a></li>
            ...
            <c:forEach var="path" items="${pathArray}" varStatus="g">
                <c:choose>
                    ...
                    <c:when test="${path eq 'workloads'}">
                        <button class="btns colors4" onclick="procMovePage('/caas/accessInfo');">Access</button>
                    </c:when>
                    <c:otherwise>
                    </c:otherwise>
                </c:choose>
