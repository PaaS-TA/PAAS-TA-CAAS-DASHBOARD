...
<script type="text/javascript">
    ...
    var getList = function() {
        procCallAjax("/workloads/namespaces/hrjin-namespace/replicasets", "GET", null, null, callbackGetList);
    };
    ...
    var getDetail = function(replicasetName) {
        procCallAjax("/workloads/namespaces/hrjin-namespace/replicasets/"+replicasetName, "GET", null, null, callbackGetDetail);
    };
