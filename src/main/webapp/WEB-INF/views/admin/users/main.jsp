...
<input type="hidden" id="serviceInstanceId" name="serviceInstanceId" value="<c:out value='${serviceInstanceId}' />" />
<input type="hidden" id="organizationGuid" name="organizationGuid" value="<c:out value='${organizationGuid}' />" />
<script type="text/javascript">
    ...
    var getUsersList = function() {
        var serviceInstanceId = $("#serviceInstanceId").val();
        var organizationGuid = $("#organizationGuid").val();

        procCallAjax(BASE_URL + "/users/getList.do?serviceInstanceId=" + serviceInstanceId + "&organizationGuid=" + organizationGuid, "GET", null, null, callbackGetUsersList);
    };
